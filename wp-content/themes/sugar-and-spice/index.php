...
get_header(); ?>
        <div id="primary" class="content-area">  
            ...
            <?php if ( count($rows)>0 ) : ?>
                ...
                if ($recipePhotoP=="BLOB"){
                    $recipePhotoP = get_template_directory_uri()."/create-image.php?id=".$row->id;
                }
                ...
                <article id="<?php echo $recipeId; ?>" <?php post_class(); ?>>
                    <div class="media">
                      ...
                      <div class="media-body">
                        ...
                        <h1 class="entry-title"><a href="/project/view-recipe?id=<?php echo  $recipeId; ?>" rel="bookmark"><?php echo $recipeName." By ".$recipeAuthor?></a></h1>
