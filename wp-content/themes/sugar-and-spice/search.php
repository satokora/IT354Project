...
get_header(); ?>
    ...
    $rows = $wpdb->get_results($wpdb->prepare("SELECT * FROM $wpdb->recipes WHERE title like %s",$keyword));

		?>

			<header class="page-header">
				<h1 class="page-title"><?php echo 'Search Results for: <span>' . str_replace("%", "", $keyword) . '</span>'; ?></h1>
			</header><!-- .page-header -->
